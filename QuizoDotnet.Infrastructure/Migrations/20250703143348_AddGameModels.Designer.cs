...
namespace QuizoDotnet.Infrastructure.Migrations
{
    ...
    [Migration("20250703143348_AddGameModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuizoDotnet.Domain.Models.Game.Category", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("QuizoDotnet.Domain.Models.Game.Question", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("QuizoDotnet.Domain.Models.Game.QuestionAnswer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("QuizoDotnet.Domain.Models.Game.Question", b =>
                {
                    b.HasOne("QuizoDotnet.Domain.Models.Game.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("QuizoDotnet.Domain.Models.Game.QuestionAnswer", b =>
                {
                    b.HasOne("QuizoDotnet.Domain.Models.Game.Question", "Question")
                        .WithMany("Answers")
